...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"00e91845-f849-4974-a6a1-9b9ff91cfb1b\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [40 x i8] c"com.github_97mith.appcontrolefinanceiro\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 100672257, ; jnienv_initialize_method_token
	i32 100672256, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.12 = internal constant [21 x i8] c"libaot-LiteDB.dll.so\00", align 16
...
@__DSOCacheEntry_name.34 = internal constant [36 x i8] c"libaot-AppControleFinanceiro.dll.so\00", align 16
...
@__DSOCacheEntry_name.56 = internal constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [578 x %struct.DSOCacheEntry] [
	...
	; 35
	%struct.DSOCacheEntry {
		i64 1184287236109492023, ; hash 0x106f6ef77455df37, from name: aot-AppControleFinanceiro.dll.so
		i8 0, ; ignore
	...
	; 58
	%struct.DSOCacheEntry {
		i64 2127848724025360653, ; hash 0x1d87a324034cc10d, from name: libaot-AppControleFinanceiro
		i8 0, ; ignore
		i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 91
	%struct.DSOCacheEntry {
		i64 3195966930663704794, ; hash 0x2c5a5afd901b08da, from name: aot-AppControleFinanceiro
		i8 0, ; ignore
		i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 228
	%struct.DSOCacheEntry {
		i64 8016794088474813882, ; hash 0x6f415fbfa8fe25ba, from name: AppControleFinanceiro.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 361
	%struct.DSOCacheEntry {
		i64 11676873656923632665, ; hash 0xa20c96b9680cb419, from name: AppControleFinanceiro
		i8 0, ; ignore
		i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 380
	%struct.DSOCacheEntry {
		i64 12146979412403611989, ; hash 0xa892bd6b0a4ce955, from name: libaot-AppControleFinanceiro.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__DSOCacheEntry_name.34, i32 0, i32 0), ; name
		i8* null; handle
	}, 
